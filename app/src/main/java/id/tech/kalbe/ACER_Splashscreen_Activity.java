...
public class ACER_Splashscreen_Activity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_acer_splashscreen);
	...
	private class LoadNext extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if (locationGot) {
				if (logged) {
					// DialogLocationConfirmation dialog = new
